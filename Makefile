...
deploy_prod: ## Make deploy prod
	@tsuru app-deploy -a globomap-driver-keystone globomap_driver_keystone Procfile requirements.txt scheduler.py run_loader.py .python-version
