...
KEYSTONE_AUTH_URL = os.getenv('AUTH_URL')
KEYSTONE_USERNAME = os.getenv('USERNAME')
KEYSTONE_PASSWORD = os.getenv('PASSWORD')
KEYSTONE_PROJECT_NAME = os.getenv('PROJECT_NAME')
KEYSTONE_USER_DOMAIN_NAME = os.getenv('USER_DOMAIN_NAME')
KEYSTONE_PROJECT_DOMAIN_NAME = os.getenv('PROJECT_DOMAIN_NAME')
